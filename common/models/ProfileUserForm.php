...
class ProfileUserForm extends Identity
{
    ...
    {
        return [
            [['username', 'first_name', 'last_name', 'email', 'phone', 'country_id', 'city', 'sex', 'password'], 'required', 'on' => 'create'],
            [['username', 'email', 'phone', 'country_id', 'city', 'sex'], 'required', 'on' => 'update'],
            [['username', 'email', 'phone', 'country_id', 'city'], 'required', 'on' => 'updateCompany'],
            [['country_id', 'city_id', 'day_birth', 'month_birth', 'year_birth', 'age', 'account_type', 'sex'], 'integer'],
    ...
    public function afterFind()
    {
        ...
        $this->country_id = $this->countryUser;
        $this->city = $this->getCityName($this->mainAddressUser);
